...
pub async fn get_user_info(con: &mut PoolConnection<Postgres>, id: i32) -> anyhow::Result<UserInfo> {
...
pub async fn user_exists(con: &mut PoolConnection<Postgres>, id: i32) -> anyhow::Result<bool> {
...
pub async fn get_user_group(con: &mut PoolConnection<Postgres>, user_id: i32) -> anyhow::Result<Option<GroupModel>> {
...
pub async fn set_user_group(con: &mut PoolConnection<Postgres>, user_id: i32, group_id: i32) -> anyhow::Result<()> {
...
pub async fn set_user_data(con: &mut PoolConnection<Postgres>, user_id: i32,  data: UserDataOptionalModel) -> anyhow::Result<()> {
...
pub async fn get_user_data(con: &mut PoolConnection<Postgres>, user_id: i32) -> anyhow::Result<UserDataModel> {
...
pub async fn reset_user_group(con: &mut PoolConnection<Postgres>, user_id: i32) -> anyhow::Result<()> {
...
pub async fn set_attendance_token(con: &mut PoolConnection<Postgres>, user_id: i32, attendance_token: Option<String>) -> anyhow::Result<()> {
