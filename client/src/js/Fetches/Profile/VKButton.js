...
import { isdev, currentHost } from '../util';
const SERVER_HOST = currentHost;

function vkAuthRedirectURL(authData) {
...
function oneTapButton(setAuthData, vkOneTapButton) {
  const vkAuthRedirectURL = SERVER_HOST+'/api/auth/redirect';
  vkOneTapButton = Connect.buttonOneTapAuth({
