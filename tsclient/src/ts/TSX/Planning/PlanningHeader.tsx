import { PlanningHeaderProps } from "../../types/tsx/Planning/PlanningHeaderTypes";
import PlanningButton from "./PlanningButton";

export default function PlanningHeader({weekParity, setWeekParity, setInCSST}: PlanningHeaderProps) {
